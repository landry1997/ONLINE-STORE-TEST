                    ...
                    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                        <div class="container-xxl">
                            <div class="d-flex flex-wrap flex-stack my-5">
                                <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Details image')); ?> - <?php echo e($image->nom); ?></h2>
                            </div>
                            <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                                <div class="symbol symbol-0px mb-5">
                                    <img alt="<?php echo e($image->nom); ?>" src="<?php echo e(asset($image->url)); ?>" class="h-70px" />
                                </div>
                                <div class="fs-5 fw-bolder mb-2">Nom: <?php echo e($image->nom); ?></div>
                                <div class="fs-5 fw-bolder mb-2">type: <?php echo e($image->typeFichier->nom); ?></div>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/authentication/images/show.blade.php ENDPATH**/ ?>