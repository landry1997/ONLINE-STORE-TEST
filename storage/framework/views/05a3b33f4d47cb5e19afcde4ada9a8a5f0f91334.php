...
<!-- Mirrored from preview.keenthemes.com/craft/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:04:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
		<title><?php echo e(__('Adisa || Tableau de bord')); ?></title>
															...
															<div class="carousel-inner pt-6">
																...
																<div class="carousel-item active">
																	<div class="carousel-wrapper">
																		<div class="d-flex flex-column justify-content-between flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">Craft Admin Launch Day</a>
																		...
																		<div class="d-flex flex-stack pt-8">
																			<span class="badge badge-light-success fs-7 fw-boldest me-2">OCT 05, 10</span>
																...
																<div class="carousel-item">
																	<div class="carousel-wrapper">
																		<!--begin::Title-->
																		<div class="d-flex flex-column justify-content-between flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">Craft Dashboard Launch</a>
																			<p class="text-gray-600 fs-6 fw-bold pt-4 mb-0">To start a blog, think of a topic about and first brainstorm ways to write details</p>
																		</div>
																		<!--end::Title-->
																		<!--begin::Info-->
																		<div class="d-flex flex-stack pt-8">
																			<span class="badge badge-light-success fs-7 fw-boldest me-2">DEC 03, 20</span>
																			<a href="#" class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade Plan</a>
																		</div>
																		<!--end::Info-->
																	</div>
																...
																<div class="carousel-item">
																	<div class="carousel-wrapper">
																		<!--begin::Title-->
																		<div class="d-flex flex-column justify-content-between flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">Reached 50,000 Sales</a>
																			<p class="text-gray-600 fs-6 fw-bold pt-4 mb-0">To start a blog, think of a topic about and first brainstorm ways to write details</p>
																		</div>
																		<!--end::Title-->
																		<!--begin::Info-->
																		<div class="d-flex flex-stack pt-8">
																			<span class="badge badge-light-success fs-7 fw-boldest me-2">NOV 06, 23</span>
																			<a href="#" class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade Plan</a>
																		</div>
																		<!--end::Info-->
																	</div>
																...
																<div class="carousel-item">
																	<div class="carousel-wrapper">
																		...
																		<!--begin::Info-->
																		<div class="d-flex flex-stack pt-8">
																			<span class="badge badge-light-success fs-7 fw-boldest me-2">AUG 01, 13</span>
																			<a href="#" class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade Plan</a>
																		</div>
																		<!--end::Info-->
																	</div>
															...
															<div class="carousel-inner pt-8">
																...
																<div class="carousel-item active">
																	<div class="carousel-wrapper">
																		...
																		<div class="flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">UI/UX Design Updates</a>
																			<p class="text-success fs-1 fw-boldest pt-5 mb-0">11:15AM - 12:30PM</p>
																		</div>
																		<!--end::Title-->
																		<!--begin::Info-->
																...
																<div class="carousel-item">
																	<div class="carousel-wrapper">
																		...
																		<div class="flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">UI/UX Design Updates</a>
																			<p class="text-success fs-1 fw-boldest pt-5 mb-0">16:15AM - 11:20PM</p>
																		</div>
																		<!--end::Title-->
																		<!--begin::Info-->
																		<div class="d-flex flex-stack pt-7">
																...
																<div class="carousel-item">
																	<div class="carousel-wrapper">
																		...
																		<div class="flex-grow-1">
																			<a href="#" class="fs-2 text-gray-800 text-hover-success fw-boldest">UI/UX Design Updates</a>
																			<p class="text-success fs-1 fw-boldest pt-5 mb-0">13:15AM - 14:30PM</p>
																		</div>
																		<!--end::Title-->
																		<!--begin::Info-->
																		<div class="d-flex flex-stack pt-7">
												...
												<div class="d-flex flex-column justify-content-between h-100">
													...
													<div class="pt-12">
														...
														<div class="text-center py-7">
															<a href="#" class="btn btn-success fs-6 px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Create App</a>
														</div>
														<!--end::Action-->
													</div>
													<!--end::Section-->
															...
															<tr>
																...
																<td class="p-0">
																	<div class="d-flex align-items-center">
																		...
																		<div class="ps-3">
																			<a href="#" class="text-gray-800 fw-boldest fs-5 text-hover-success mb-1">Brad Simmons</a>
															...
															<tr>
																...
																<td class="p-0">
																	<div class="d-flex align-items-center">
																		...
																		<div class="ps-3">
																			<a href="#" class="text-gray-800 fw-boldest fs-5 text-hover-success mb-1">Jessie Clarcson</a>
															...
															<tr>
																...
																<td class="p-0">
																	<div class="d-flex align-items-center text-start">
																		...
																		<div class="ps-3">
																			<a href="#" class="text-gray-800 fw-boldest fs-5 text-hover-success mb-1">Lebron Wayde</a>
															...
															<tr>
																...
																<td class="p-0">
																	<div class="d-flex align-items-center text-start">
																		...
																		<div class="ps-3">
																			<a href="#" class="text-gray-800 fw-boldest fs-5 text-hover-success mb-1">Natali Trump</a>
									...
									<div class="col-xxl-4">
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 py-5">
												...
												<div class="card-toolbar">
													<!--begin::Menu-->
													<button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-success btn-active-light-success me-n3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
													...
													<!--begin::Menu 2-->
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-success fw-bold w-200px" data-kt-menu="true">
														<!--begin::Menu item-->
												...
												<div class="mt-n20 pb-5 position-relative zindex-1">
													...
													<div class="d-flex flex-stack mb-6">
														...
														<div class="d-flex align-items-center me-2">
															...
															<!--begin::Title-->
															<div>
																<a href="#" class="fs-5 text-gray-800 text-hover-success fw-boldest">Global Stars</a>
													...
													<div class="d-flex flex-stack mb-6">
														...
														<div class="d-flex align-items-center me-2">
															...
															<!--begin::Title-->
															<div>
																<a href="#" class="fs-5 text-gray-800 text-hover-success fw-boldest">Focus Keeper</a>
													...
													<div class="d-flex flex-stack mb-">
														...
														<div class="d-flex align-items-center me-2">
															...
															<!--begin::Title-->
															<div>
																<a href="#" class="fs-5 text-gray-800 text-hover-success fw-boldest">High Tower</a>
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<div class="card-header align-items-center border-0 mt-5">
												...
												<div class="card-toolbar">
													<!--begin::Menu-->
													<button type="button" class="btn btn-active-light-success btn-sm btn-icon btn-icon-success btn-active-light-success me-n3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
														<!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
														<span class="svg-icon svg-icon-3 svg-icon-success">
															<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6139ea442304f">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6139ea442304f" data-allow-clear="true">
																		<option></option>
											...
											<div class="card-body pt-5">
												...
												<div class="d-flex flex-stack mb-7">
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Title-->
														<div class="ps-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-success fw-boldest">Anne Clarc</a>
												...
												<div class="d-flex flex-stack mb-7">
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Title-->
														<div class="ps-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-success fw-boldest">Brad Simmons</a>
												...
												<div class="d-flex flex-stack mb-7">
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Title-->
														<div class="ps-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-success fw-boldest">Randy Trent</a>
												...
												<div class="d-flex flex-stack mb-7">
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Title-->
														<div class="ps-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-success fw-boldest">Ricky Hunt</a>
												...
												<div class="d-flex flex-stack mb-">
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Title-->
														<div class="ps-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-success fw-boldest">Jessie Clarcson</a>
												...
												<div class="position-relative">
													...
													<div class="d-flex flex-stack pb-10">
														...
														<div class="d-flex">
															...
															<!--begin::Title-->
															<div class="pe-3">
																<a href="#" class="fs-5 text-gray-800 text-hover-success fw-boldest">New Order Placed</a>
																<div class="text-gray-400 fw-bold mt-1">
																<a href="#" class="link-success pe-1">#XDT-034</a>order received</div>
															</div>
															<!--end::Title-->
														</div>
														<!--end::Section-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex">
															...
															<!--begin::Title-->
															<div class="pe-3">
																<a href="#" class="fs-5 text-gray-800 text-hover-success fw-boldest">New Story Created</a>
																<div class="text-gray-400 fw-bold mt-1">
																<a href="#" class="link-success pe-1">#XDT-034</a>order received</div>
															</div>
															<!--end::Title-->
																	...
																	<div class="fv-row">
																		...
																		<label class="d-flex flex-stack cursor-pointer">
																			...
																			<span class="d-flex align-items-center me-2">
																				...
																				<span class="symbol symbol-50px me-6">
																					<span class="symbol-label bg-light-success">
																						<i class="fab fa-vuejs text-success fs-2x"></i>
																					</span>
																				</span>
																				<!--end:Icon-->
																				<!--begin:Info-->
															...
															<div data-kt-stepper-element="content">
																<div class="w-100 text-center">
																	...
																	<div class="d-flex flex-center pb-5">
																		...
																		<a href="pages/profile/documents.html" class="btn btn-lg btn-success">View App</a>
																	</div>
																	<!--end::Actions-->
																	<!--begin::Illustration-->
													...
													<div class="row mt-10">
														...
														<div class="col-lg-6 mb-10 mb-lg-0">
															...
															<div class="nav flex-column">
																<!--begin::Tab link-->
																<div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-success d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
																	<!--end::Description-->
																	<div class="d-flex align-items-center me-2">
																		<!--begin::Radio-->
																...
																<!--end::Tab link-->
																<!--begin::Tab link-->
																<div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-success d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_advanced">
																	<!--end::Description-->
																	<div class="d-flex align-items-center me-2">
																		<!--begin::Radio-->
																		<div class="form-check form-check-custom form-check-solid form-check-success me-6">
																...
																<!--end::Tab link-->
																<!--begin::Tab link-->
																<div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-success d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_enterprise">
																	<!--end::Description-->
																	<div class="d-flex align-items-center me-2">
																		<!--begin::Radio-->
																		<div class="form-check form-check-custom form-check-solid form-check-success me-6">
									...
									<div class="modal-dialog mw-1000px">
										...
										<div class="modal-content">
											...
											<div class="modal-footer d-flex justify-content-end">
												...
												<button type="button" id="kt_modal_select_location_button" class="btn btn-success" data-bs-dismiss="modal">Apply</button>
											</div>
											<!--end::Modal footer-->
										</div>
										<!--end::Modal content-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="notice d-flex bg-light-success rounded border-success border border-dashed min-w-lg-600px flex-shrink-0 p-6">
											...
											<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
												...
												<!--end::Content-->
												<!--begin::Action-->
												<a href="#" class="btn btn-success px-6 align-self-center text-nowrap">Proceed</a>
												<!--end::Action-->
											</div>
											<!--end::Wrapper-->
										</div>
			...
			<div class="card w-100 rounded-0" id="kt_drawer_chat_messenger">
				...
				<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
					...
					<div class="card-title">
						...
						<div class="d-flex justify-content-center flex-column me-3">
							<a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-success me-1 mb-2 lh-1">Brian Cox</a>
							<!--begin::Info-->
							<div class="mb-0 lh-1">
					...
					<div class="card-toolbar">
						<!--begin::Menu-->
						<div class="me-2">
							<button class="btn btn-sm btn-icon btn-active-light-success" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Details-->
									<div class="ms-3">
										<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-success me-1">Brian Cox</a>
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<div class="me-3">
										...
										<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-success ms-1">You</a>
									</div>
									<!--end::Details-->
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 rounded bg-light-success text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text">Hey there, we’re just writing to let you know that you’ve been subscribed to a repository on GitHub.</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 rounded bg-light-success text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text">You’ll receive notifications for all issues, pull requests!</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 rounded bg-light-success text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text">Most purchased Business courses during this sale!</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="d-flex justify-content-end mb-10 d-none" data-kt-element="template-out">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 rounded bg-light-success text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text"></div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
				...
				<div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
					...
					<div class="d-flex flex-stack">
						<!--begin::Actions-->
						<div class="d-flex align-items-center me-2">
							<button class="btn btn-sm btn-icon btn-active-light-success me-1" type="button" data-bs-toggle="tooltip" title="Coming soon">
						...
						<!--end::Actions-->
						<!--begin::Send-->
						<button class="btn btn-success" type="button" data-kt-element="send">Send</button>
						<!--end::Send-->
					</div>
					<!--end::Toolbar-->
				</div>
											...
											<div class="fv-row mb-8">
												...
												<div class="dropzone" id="kt_modal_create_project_settings_logo">
													...
													<div class="dz-message needsclick">
														...
														<span class="svg-icon svg-icon-3hx svg-icon-success">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												...
												<div class="mh-300px scroll-y me-n7 pe-7">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Emma Smith</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Melody Macy</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Max Smith</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Sean Bean</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Brian Cox</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Mikaela Collins</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Francis Mitcham</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Olivia Wild</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<span class="symbol-label bg-light-success text-success fw-bold">N</span>
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Neil Owen</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Dan Wilson</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Emma Bold</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Ana Crown</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Robert Doe</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">John Miller</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Lucy Kunic</a>
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Ethan Wilder</a>
												...
												<div class="mh-300px scroll-y me-n7 pe-7">
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-6">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Avionica Technical Requirements</a>
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-6">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">9 Degree CURD draftplan</a>
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-6">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">User CRUD Styles</a>
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-6">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Craft Initial Logo</a>
													...
													<div class="d-flex flex-stack py-4">
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-6">
																<a href="#" class="fs-5 fw-boldest text-gray-900 text-hover-success mb-2">Tower Hill Bilboard</a>
									...
									<div data-kt-stepper-element="content">
										...
										<div class="w-100">
											...
											<div class="d-flex flex-center pb-20">
												...
												<a href="pages/projects/project.html" class="btn btn-lg btn-success">View Project</a>
											</div>
											<!--end::Actions-->
											<!--begin::Illustration-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="btn btn-light-success fw-boldest w-100 mb-8">
...
<!-- Mirrored from preview.keenthemes.com/craft/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:05:16 GMT -->
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\adisa2\resources\views/home.blade.php ENDPATH**/ ?>