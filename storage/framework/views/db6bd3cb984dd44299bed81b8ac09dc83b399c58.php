...
<head>
    <title><?php echo e(__('Liste des livres')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des livre')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                    ...
                    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                        <div class="container-xxl">
                            <div class="d-flex flex-wrap flex-stack my-5">
                                <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Liste des livres')); ?></h2>
                            </div>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                            ...
                                            <a href="#" class="text-gray-800 text-hover-primary d-flex flex-column">
                                                ...
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="fs-5 fw-bolder mb-2"><?php echo e($livre->nom); ?></div>
                                                <!--end::Title-->
                                            </a>
                                            <!--end::Name-->
                                            <!--begin::Description-->
                                            ...
                                            <!--end::Description-->
                                            <a class="btn-btn-dark" href="<?php echo e(url('/livres/'.$livre->id)); ?>"><?php echo e(__('Voir le détail')); ?></a>
...
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/authentication/pdf/index.blade.php ENDPATH**/ ?>