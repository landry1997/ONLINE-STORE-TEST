                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                                        ...
                                        <div class="d-flex overflow-auto">
                                            <!--begin::Nav links-->
                                            <ul
                                                class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-bold flex-nowrap h-55px">
                                                <!--begin::Nav item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary me-6"
                                                        href="project.html">Overview</a>
                                                </li>
                                                <!--end::Nav item-->
                                                <!--begin::Nav item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary me-6"
                                                        href="targets.html">Targets</a>
                                                </li>
                                                <!--end::Nav item-->
                                                <!--begin::Nav item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary me-6"
                                                        href="budget.html">Budget</a>
                                                </li>
                                                <!--end::Nav item-->
                                                <!--begin::Nav item-->
                                                <li class="nav-item">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Ajouter des images')); ?></h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                    ...
                                    <div class="col-lg-6 mx-auto">
                                        ...
                                        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                            ...
                                            <label id="upload-label" for="image"
                                                class="font-weight-light text-muted"><?php echo e(__('Choisir une image')); ?></label>
                                            <div class="input-group-append">
                                                <label for="image" class="btn btn-light m-0 rounded-pill px-4"> <i
                                                        class="fa fa-cloud-upload mr-2 text-muted"></i><small
                                                        class="text-uppercase font-weight-bold text-muted"><?php echo e(__('Choisir une image')); ?></small></label>
                                            </div>
                                        </div>
								...
								<center>
									<div class="col-md-4">
										<label for="validationCustom02"
											class="form-label"><?php echo e(__('Nom de l\'image')); ?></label>
...
<?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/authentication\images\create.blade.php ENDPATH**/ ?>