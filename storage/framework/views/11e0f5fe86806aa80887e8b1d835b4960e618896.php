                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-500px">
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-15">
                        <a href="#" class="py-9 pt-lg-20">
                            <img alt="Logo" src="<?php echo e(asset('logo.png')); ?>" class="h-200px" />
                        </a>
                        <h1 class="fw-bolder text-primary fs-2qx pb-5 pb-md-10"><?php echo e(__('Bienvenue sur ADISA by PLF')); ?></h1>
                    ...
                    <div class="w-lg-500px p-12 p-lg-15 mx-auto">
                        <form class="form w-100" id="kt_sign_in_form" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" class="form-control form-control-lg form-control-solid <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-lg btn-dark fw-bolder me-3 my-2">
                                 ...
                                 <a href="<?php echo e(route('password.request')); ?>" style="margin-left:10rem; margin-top:10rem;" class="link-primary fs-6 fw-bolder text-center"><?php echo e(__('Mot de passe oublié')); ?> ?</a>
                        </form>
                    </div>
                </div>
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO/resources/views/auth/login.blade.php ENDPATH**/ ?>