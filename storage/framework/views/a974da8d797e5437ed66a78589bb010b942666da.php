...
<head>
    <title><?php echo e(__('Changer un livre')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Changer un livre')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Changer un livre')); ?></h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Row-->
                                <form action="<?php echo e(url('/livres/'.$livre->id)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row py-4">
                                        <div class="col-lg-6 mx-auto">
                                            ...
                                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                                ...
                                                <label id="upload-label" for="image" class="font-weight-light text-muted"><?php echo e(__('Choisir un livre')); ?></label>
                                                <div class="input-group-append">
                                                    <label for="image" class="btn btn-light m-0 rounded-pill px-4"> <i class="fa fa-cloud-upload mr-2 text-muted"></i><small class="text-uppercase font-weight-bold text-muted"><?php echo e(__('Choisir un livre')); ?></small></label>
                                                </div>
                                            </div>
                                    ...
                                    <center>
                                        <div class="col-md-4">
                                            <label for="validationCustom02" class="form-label"><?php echo e(__('Nom du livre')); ?></label>
                                            <input type="text" class="form-control" id="validationCustom02" name="nom" value="<?php echo e($livre->nom); ?>" required>
                                            <div class="invalid-feedback">
                                                <?php echo e(__('Veuillez entrer le nom du livre')); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select statut" id="validationCustom07" name="statut" required>
                                                <option selected value="<?php echo e($livre->statut); ?>"><?php echo e($livre->statut); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <center>
                                        <button type="submit" class="btn btn-dark"><?php echo e(__('Editer')); ?></button>
                                    </center>
                                </form>
                            </div>
                            <!--end:Row-->
...
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/authentication/pdf/edit.blade.php ENDPATH**/ ?>