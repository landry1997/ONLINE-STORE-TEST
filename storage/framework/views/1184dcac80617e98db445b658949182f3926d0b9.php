...
<head>
    <title><?php echo e(__('Créer les centres d\'interets')); ?> || Adisa</title>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('créer les interetss')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">
                                        <?php echo e(__('créer sur les centres d\'interet')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="<?php echo e(route('interet.store')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="col-md-6">
...
<?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/apps/user-management/interet/create.blade.php ENDPATH**/ ?>