						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Détails de ')); ?><?php echo e($user->name); ?></h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
											...
											<div class="card-body">
												...
												<div id="kt_user_view_details" class="collapse show">
													<div class="pb-5 fs-6">
														...
														<div class="text-gray-600">25 Jul 2021, 9:23 pm</div>
														<!--begin::Details item-->
													</div>
												</div>
												<!--end::Details content-->
											...
											<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
												...
												<form id="kt_modal_update_email_form" class="form" action="#">
													...
													<div class="fv-row mb-7">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input class="form-control form-control-solid" placeholder="" name="name" value="<?php echo e($user->name); ?>" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Actions-->
												...
												<form id="kt_modal_update_email_form" class="form" action="#">
													...
													<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
														...
														<div class="d-flex flex-stack flex-grow-1">
															<!--begin::Content-->
															<div class="fw-bold">
																<div class="fs-6 text-gray-700"><?php echo e(__('Vous allez recevoir un mail de validation. Veuillez remplir les champs')); ?>.</div>
															</div>
															<!--end::Content-->
														</div>
														<!--end::Wrapper-->
													...
													<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="fs-6 fw-bold form-label mb-2">
															<span class="required">E<?php echo e(__('Addresse mail')); ?></span>
														</label>
														<!--end::Label-->
														<!--begin::Input-->
														<input class="form-control form-control-solid" placeholder="" name="email" value="<?php echo e($user->email); ?>" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Actions-->
...
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\adisa2\resources\views/apps/user-management/users/view.blade.php ENDPATH**/ ?>