...
<head>
    <title><?php echo e(__('Detals de la video')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Details de la video')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                    ...
                    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                        <div class="container-xxl">
                            <div class="d-flex flex-wrap flex-stack my-5">
                                <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Details de la video')); ?> - <?php echo e($video->nom); ?></h2>
                            </div>
                            <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                                ...
                                <div class="fs-5 fw-bolder mb-2">Nom: <?php echo e($video->nom); ?></div>
                                <div class="fs-5 fw-bolder mb-2">type: <?php echo e($video->typeFichier->nom); ?></div>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/authentication/videos/show.blade.php ENDPATH**/ ?>