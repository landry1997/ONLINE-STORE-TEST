            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <form class="row g-3 needs-validation" novalidate>
                        <div class="col-md-6">
                            <label for="validationCustom01 text-center" class="form-label"><?php echo e(__('Nom du pilier en francais')); ?></label>
                            <input type="text" class="form-control text-center" id="validationCustom01" value="<?php echo e($piliers->titre); ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom02 text-center" class="form-label"><?php echo e(__('Nom du pilier en anglais')); ?></label>
                            <input type="text" class="form-control text-center" id="validationCustom02" value="<?php echo e($piliers->titre_en); ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom04 text-center" class="form-label"><?php echo e(__('Contenu en francais')); ?></label>
                            <input type="text" class="form-control text-center" id="validationCustom04" value="<?php echo e($piliers->contenu); ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom05 text-center" class="form-label"><?php echo e(__('Contenu en anglais')); ?></label>
                            <input type="text" class="form-control text-center" id="validationCustom04" value="<?php echo e($piliers->contenu_en); ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom05 text-center" class="form-label"><?php echo e(__('Statut')); ?></label>
                        ...
                        <div class="col-md-6">
                            <img src="<?php echo e($piliers->image); ?>" alt="<?php echo e($piliers->titre); ?>">
                        </div>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/account/orders/piliersview.blade.php ENDPATH**/ ?>