...
<head>
    <title><?php echo e(__('Liste des abonnements des utilisateurs')); ?> || Adisa</title>
                        ...
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Gestion des abonnements des utilisateurs')); ?></li>
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('abonnements')); ?></li>
                                    <li class="breadcrumb-item text-dark"><?php echo e(__('Liste des abonnements des utilisateurs')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            <!--begin::Filter-->
                                        <a href="<?php echo e(route('abonnement.create')); ?>" class="btn btn-dark"><?php echo e(__('Créer un nouvel abonnement')); ?></a>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px"><?php echo e(__('Utilisateur')); ?></th>
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <?php $__currentLoopData = $abonnements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($abon->user); ?></td>
                                                    <td><?php echo e($abon->prix); ?></td>
                                                    <td><?php echo e($abon->created_at); ?></td>
                                                    <td><?php echo e($abon->dateFin); ?></td>
                                                    <td class="text-end">
                                                        <a href="#"
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO-main/resources/views/apps/user-management/abonnements/userabonneabonnement.blade.php ENDPATH**/ ?>