...
<head>
    <title><?php echo e(__('Liste des zones de livraison')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des lieux de livraison')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Liste des lieux')); ?></li>
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Lieux de livraison')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                            ...
                            <div class="d-flex align-items-center flex-nowrap text-nowrap py-1">
                                <a href="<?php echo e(route('zones.create')); ?>" class="btn bg-body btn-color-gray-600 btn-active-primary me-4"><?php echo e(__('Créer un nouveau Lieux de livraison')); ?></a>
                            </div>
                            <!--end::Actions-->
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="kt_orders_classic" class="table table-row-bordered table-row-dashed g-3 gs-0 align-middle">
                                        <thead class="fs-7 fw-boldest text-gray-400 text-uppercase">
                                            <tr>
                                                <th class="min-w-100px"><?php echo e(__('Ville')); ?></th>
                                                <th class="min-w-130px"><?php echo e(__('Quartier')); ?></th>
                                                <th class="min-w-160px"><?php echo e(__('Rue')); ?></th>
                                                <th class="min-w-100px"><?php echo e(__('Createur')); ?></th>
                                                <th class="min-w-160px"><?php echo e(__('Statut')); ?></th>
                                                ...
                                                <td> 
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <a href="#" class="mb-1 text-gray-800 text-hover-primary"><?php echo e($zone->nom_ville); ?></a>
                                                        </div>
                                                    </div>
                                                    <!--end::Wrapper-->
                                                </td>
                                                <td><?php echo e($zone->nom_quartier); ?></td>
                                                <td><?php echo e($zone->nom_rue); ?></td>
                                                <td>
                                                    <?php if(empty($zone->createur)): ?>
                                                                <p>Pas de créateur</p>
                                                                <?php else: ?>
                                                                <?php echo e($zone->createur); ?>

                                                            <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($zone->statut == "actif"): ?>
                                                    <span class="badge badge-light-info fw-boldest"><?php echo e($zone->statut); ?></span>
                                                    <?php else: ?>
                                                    <span class="badge badge-light-danger fw-boldest"><?php echo e($zone->statut); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <!-- Button trigger modal -->
                                                    <a href="<?php echo e(route('zones.views', $zone->id)); ?>" class="btn btn-light btn-sm"><?php echo e(__('Voir')); ?></a>
                                                    <a href="<?php echo e(route('zonesedit', $zone->id)); ?>" class="btn btn-light btn-sm"><?php echo e(__('Editer')); ?></a>
                                                </td>
                                            </tr>
...
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/account/orders/zone.blade.php ENDPATH**/ ?>