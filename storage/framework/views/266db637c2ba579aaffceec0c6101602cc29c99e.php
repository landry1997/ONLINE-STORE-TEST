...
<head>
    <title><?php echo e(__('Editer une video')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Edter une video')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Editer une video')); ?></h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Row-->
                                <form action="<?php echo e(url('/videos/'.$video->id)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row py-4">
                                    ...
                                    <center>
                                        <div class="col-md-4">
                                            <label for="validationCustom02" class="form-label"><?php echo e(__('Nom du video')); ?></label>
                                            <input type="text" class="form-control" id="validationCustom02" name="nom" value="<?php echo e($video->nom); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select statut" id="validationCustom07" name="statut" required>
                                                <option selected value="<?php echo e($video->statut); ?>"><?php echo e($video->statut); ?></option>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/authentication/videos/edit.blade.php ENDPATH**/ ?>