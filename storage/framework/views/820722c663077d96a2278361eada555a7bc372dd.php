                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-success fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5">
                            <a href="pages/profile/overview.html" class="menu-link px-5"><?php echo e(__('Profile')); ?></a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
...
<!--end::Header--><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/layouts/header2.blade.php ENDPATH**/ ?>