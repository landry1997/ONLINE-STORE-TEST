...
<head>
    <title><?php echo e(__('Liste des categories des articles')); ?> || Adisa </title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des categories')); ?></h1>
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
                                                                ...
                                                                <option value="<?php echo e($category->createur); ?>"><?php echo e($category->createur); ?></option>
                                            ...
                                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer"><?php echo e(__("creer une categorie")); ?></button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-60px"><?php echo e(__("Titre en anglais")); ?></th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Name=-->
                                                <td>
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo e($category->titre); ?></a>
                                                </td>
                                                <!--end::Name=-->
                                                <!--begin::Email=-->
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1"><?php echo e($category->titreEn); ?></a>
                                                </td>
                                                <!--end::Email=-->
                                                <!--begin::Company=-->
                                                <td><?php echo e($category->statut); ?></td>
                                                <!--end::Company=-->
                                                <!--begin::Payment method=-->
                                                <td data-filter="american_express"><?php echo e($category->created_at); ?></td>
                                                <td><?php echo e($category->createur); ?></td>
                                                <!--end::Date=-->
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="<?php echo e(route('categories.show', $category->id)); ?>" class="menu-link px-3"><?php echo e(__("Detail")); ?></a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row"><?php echo e(__("Desactiver")); ?></a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                            ...
                            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        <!--begin::Form-->
                                        <form class="form" action="<?php echo e(route('categories.store')); ?>" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="list.html">
                                            <!--begin::Modal header-->
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-header" id="kt_modal_add_customer_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder"><?php echo e(__("creer une categorie")); ?></h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid" placeholder="" name="titre"/>

                                                        <label class="required fs-6 fw-bold mb-2"><?php echo e(__("Titre en anglais")); ?></label>
                                                        <input type="text" class="form-control form-control-solid" placeholder="" name="titreEn"/>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_customers_export_form" class="form" action="#">
                                                ...
                                                <div class="row fv-row mb-15">
                                                    <!--begin::Label-->
                                                    <label class="fs-5 fw-bold form-label mb-5">Statut:</label>
                                                    <!--end::Label-->
                                                    <!--begin::Radio group-->
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
																...
																<span class="form-check-label text-gray-600 fw-bold">valide</span>
															</label>
                                                        <!--end::Radio button-->
                                                        <!--begin::Radio button-->
                                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
																<input class="form-check-input" type="checkbox" value="3" name="payment_type" />
																<span class="form-check-label text-gray-600 fw-bold">invalide</span>
															</label>
                                                        <!--end::Radio button-->
                                                        <!--begin::Radio button-->
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO-main/resources/views/apps/categories/list.blade.php ENDPATH**/ ?>