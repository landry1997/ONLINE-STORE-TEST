...
<head>
    <title><?php echo e(__('Editer les abonnement')); ?> || Adisa</title>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Editer les abonnement')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">
                                        <?php echo e(__('Détails sur les abonnements')); ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="<?php echo e(route('abonnement.update', $abonnement->id)); ?>" novalidate>
                        <?php echo csrf_field(); ?>

                        <div class="col-md-6">
                            <label for="validationCustom04 text-center"
                                class="form-label"><?php echo e(__('Durée')); ?></label>
                            <input type="number" class="form-control text-center" name="durée" id="validationCustom03"
                                value="<?php echo e($abonnement->durée); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom04 text-center"
                                class="form-label"><?php echo e(__('Prix')); ?></label>
                            <input type="number" class="form-control text-center" name="prix" id="validationCustom04"
                                value="<?php echo e($abonnement->prix); ?>">
                        </div>
...
<?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/apps/user-management/abonnements/edit.blade.php ENDPATH**/ ?>