...
<head>
		<title><?php echo e(__('Liste des utilisateurs')); ?> || Adisa</title>
						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder my-1 fs-2">Users List</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<!--begin::Input group-->
														<div class="mb-10">
															<label class="form-label fs-6 fw-bold"><?php echo e(__('Valide')); ?>:</label>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px"><?php echo e(__('Utilisateur')); ?></th>
													<th class="min-w-125px"><?php echo e(__('Role')); ?></th>
													<th class="min-w-125px"><?php echo e(__('Date de validation')); ?></th>
													<th class="min-w-125px"><?php echo e(__('Statut')); ?></th>
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="view.html">
																	<div class="symbol-label">
																		<img src="../../../assets/media/avatars/150-1.jpg" alt="<?php echo e($user->name); ?> " class="w-100" />
																	</div>
																</a>
															</div>
															<!--end::Avatar-->
															...
															<div class="d-flex flex-column">
																<a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo e($user->name); ?> </a>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?php echo e(route('users.edit', $user->id)); ?>" class="menu-link px-3 text-danger"><?php echo e(__('Editer')); ?></a>
																</div>
																<div class="menu-item px-3">
																	<a href="<?php echo e(route('users.show', $user->id)); ?>" class="menu-link px-3 text-info"><?php echo e(__('Voir')); ?></a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
...
<!-- Mirrored from preview.keenthemes.com/craft/apps/user-management/users/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:06:32 GMT -->
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\adisa2\resources\views/apps/user-management/users/list.blade.php ENDPATH**/ ?>