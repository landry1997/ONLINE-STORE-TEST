...
<head>
    <title><?php echo e(__('Ajouter des pîliers')); ?> || Adisa</title>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Créer un nouveau pilier')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                    ...
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('pilier.store')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="validationCustom03"
                                class="form-label"><?php echo e(__('Description du pilier en francais')); ?></label>
                            <textarea class="form-control" id="validationCustom03" name="contenu"
                                placeholder="<?php echo e(__('Description')); ?>" required></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            <label for="validationCustom03"
                                class="form-label"><?php echo e(__('Description du pilier en anglais')); ?></label>
                            <textarea class="form-control" id="validationCustom03" name="contenu_en"
                                placeholder="<?php echo e(__('Description')); ?>" required></textarea>
                            <div class="invalid-feedback">
...
<?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/account/orders/addPilier.blade.php ENDPATH**/ ?>