        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20">
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-lg btn-dark"><?php echo e(__('Se connecter')); ?></a>
                </div>
            </div>
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO/resources/views/welcome.blade.php ENDPATH**/ ?>