                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des utilisateurs')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Utilisateurs')); ?></li>
                                    <li class="breadcrumb-item text-dark"><?php echo e(__('Liste des utilisateurs')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            ...
                                            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary">
                                                ...
                                                <!--end::Svg Icon--><?php echo e(__('Créer un utilisateur')); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <div
                                                            ...
                                                            <a href="view.html">
                                                                <div class="symbol-label">
                                                                        ...
                                                                        <img src="<?php echo e(asset('assets/media/avatars/SMART_2.JPG')); ?>"
                                                                        alt="<?php echo e($user->name); ?> "
                                                                        class="w-100" />
                                                                </div>
                                                                    <?php else: ?><img src="../../../assets/media/avatars/blank.png"
                                                                        alt="<?php echo e($user->name); ?> "
                                                                        class="w-100" />
                                                                </div>
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <a href="view.html"
                                                                class="text-gray-800 text-hover-primary mb-1"><?php echo e($user->name); ?>
...
<?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/apps/user-management/users/list.blade.php ENDPATH**/ ?>