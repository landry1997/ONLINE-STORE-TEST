...
<head>
    <title><?php echo e(__('Liste des cours')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des cours')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><?php echo e(__('Liste des cours')); ?></li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                                    ...
                                    <table id="kt_orders_classic" class="table table-row-bordered table-row-dashed g-3 gs-0 align-middle">
                                        <thead class="fs-7 fw-boldest text-gray-400 text-uppercase">
                                            <tr>
                                                ...
                                                <th class="min-w-200px"><?php echo e(__('Description')); ?></th>
                                                <th class="min-w-200px"><?php echo e(__('Statut')); ?></th>
                                        ...
                                        <tbody class="fs-6 fw-boldest">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="symbol symbol-75px me-6 bg-light">
                                                            <img src="<?php echo e(asset($cour->image)); ?>" alt="<?php echo e($cour->nom); ?>" />
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Info-->
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <a href="<?php echo e(route('coursedit', $cour->id)); ?>" class="mb-1 text-gray-800 text-hover-primary"><?php echo e($cour->nom); ?></a>
                                                            <a href="<?php echo e(route('coursedit', $cour->id)); ?>" class="mb-1 text-gray-800 text-hover-primary"><?php echo e($cour->type); ?></a>
                                                            <div class="fw-bold text-gray-400">par:<?php echo e($cour->createur); ?></div>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::Wrapper-->
                                                ...
                                                <td>
                                                    <?php if($cour->statut == "actif"): ?>
                                                    <span class="badge badge-light-info fw-boldest"><?php echo e($cour->statut); ?></span>
                                                    <?php else: ?>
                                                    <span class="badge badge-light-danger fw-boldest"><?php echo e($cour->statut); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <!-- Button trigger modal -->
                                                    <a href="<?php echo e(route('coursview', $cour->id)); ?>" class="btn btn-light btn-sm"><?php echo e(__('Voir')); ?></a>
                                                    <a href="<?php echo e(route('coursedit', $cour->id)); ?>" class="btn btn-light btn-sm"><?php echo e(__('Editer')); ?></a>
                                                </td>
                                            </tr>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/account/orders/cours.blade.php ENDPATH**/ ?>