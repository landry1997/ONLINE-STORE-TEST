									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="<?php echo e(route('abonnement-list')); ?>">
												...
												<span class="menu-title"><?php echo e(__('Liste des abonnements')); ?></span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="<?php echo e(route('user-list')); ?>">
												...
												<span class="menu-title"><?php echo e(__('Modifier l\'abonnements')); ?></span>
											</a>
										</div>
									</div>
								</div>
				...
				<!--end::Aside--><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>