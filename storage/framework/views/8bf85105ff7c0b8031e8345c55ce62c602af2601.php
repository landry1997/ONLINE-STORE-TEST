...
<head>
    <title><?php echo e(__('Details de cette categorie')); ?> || Adisa </title>
						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
									<h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Details sur la categories')); ?></h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><a href="<?php echo e(route('categories-list')); ?>"><?php echo e(__("Liste des articles")); ?></a></li>
                                    <li class="text-muted"><?php echo e(__("details de cet article")); ?></li>
                                </ul>
								</div>
							</div>
						</div>
							...
							<div class="container-xxl">
										...
										<div class="card mb-5 mb-xl-8">
											...
											<div class="card-body pt-15">
												...
												<div class="d-flex flex-center flex-column mb-5">
													...
													<!--end::Name-->
													<!--begin::Position-->
													<div class="fs-5 fw-bold text-muted mb-6"><?php echo e($categories->titre); ?></div>
													<!--end::Position-->
													<!--begin::Info-->
												...
												<div id="kt_customer_view_details" class="collapse show">
													<div class="py-5 fs-6">
														...
														<div class="text-gray-600"><?php echo e($categories->titre); ?></div>
                                                        <div class="fw-bolder mt-5"><?php echo e(__("Titre en anglais")); ?></div>
														<div class="text-gray-600"><?php echo e($categories->titreEn); ?></div>
                                                        <div class="fw-bolder mt-5"><?php echo e(__("Creteur")); ?></div>
														<div class="text-gray-600"></div>
														<div class="fw-bolder mt-5"><?php echo e(__("statut")); ?></div>
                                                        <div class="text-gray-600"><?php echo e($categories->statut); ?></div>
														<div class="fw-bolder mt-5"><?php echo e(__("Date de creation")); ?></div>
														<div class="text-gray-600"><?php echo e($categories->created_at); ?></div>
													</div>
												</div>
												<!--end::Details content-->
											</div>
												...
												<div class="card pt-4 mb-6 mb-xl-9">
													...
													<div class="card-header border-0">
														...
														<div class="card-title">
															<h2><?php echo e(__("Liste des articles")); ?></h2>
														</div>
														<!--end::Card title-->
														<!--begin::Card toolbar-->
								...
								<div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
											<form class="form" method="POST" action="<?php echo e(route('categories.update', $categories->id)); ?>">
												<!--begin::Modal header-->
                                                <?php echo csrf_field(); ?>
												<div class="modal-header" id="kt_modal_update_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><?php echo e(__("Editer la categorie")); ?></h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													...
													<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_customer_header" data-kt-scroll-wrappers="#kt_modal_update_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div id="kt_modal_update_customer_user_info" class="collapse show">
															...
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="titre" value="<?php echo e($categories->titre); ?>" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="titreEn" value="<?php echo e($categories->titreEn); ?>" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-15">
                                                                ...
                                                                <select class="form-select" id="validationCustom04" name="statut" required>
                                                                    <option selected value="<?php echo e($categories->statut); ?>"><?php echo e($categories->statut); ?>
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO/resources/views/apps/categories/view.blade.php ENDPATH**/ ?>