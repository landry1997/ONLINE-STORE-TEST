...
<head>
    <title><?php echo e(__('Ajouter des livres')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Ajouter des livres')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Ajouter des livres')); ?></h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Row-->
                                <form action="<?php echo e(route('livre.store')); ?>" method="POST" role="form" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Sipoufo\Documents\Projects\ADISA-BO\resources\views/authentication/pdf/create.blade.php ENDPATH**/ ?>