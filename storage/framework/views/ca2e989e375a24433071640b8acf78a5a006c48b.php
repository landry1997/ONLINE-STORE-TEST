...
<head>
    <title><?php echo e(__('Liste des articles du blog')); ?> || Adisa </title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Liste des articles')); ?></h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    <li class="breadcrumb-item text-muted">
                                        <a href="/home" class="text-muted text-hover-primary"><?php echo e(__('Tableau de bord')); ?></a>
                                    </li>
                                    <li class="breadcrumb-item text-muted"><?php echo e(__("Blog")); ?></li>
                                    <li class="breadcrumb-item text-muted"><?php echo e(__("Liste des articles")); ?></li>
                                </ul>
                            </div>
                            <!--end::Info-->
                            <!--begin::Actions-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer"><?php echo e(__("creer un article")); ?></button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px"><?php echo e(__("titre")); ?></th>
                                                <th class="min-w-60px"><?php echo e(__("description")); ?></th>
                                                <th class="min-w-100px"><?php echo e(__("Date de creation")); ?></th>
                                                <th class="min-w-100px"><?php echo e(__("Categorie")); ?></th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Name=-->
                                                <td>
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo e($article->titre); ?></a>
                                                </td>
                                                <!--end::Name=-->
                                                <!--begin::Email=-->
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1"><?php echo e($article->description); ?></a>
                                                </td>
                                                <!--end::Email=-->
                                                <!--begin::Company=-->
                                                ...
                                                <td data-filter="american_express"><?php echo e($article->catId); ?></td>
                                                <td><?php echo e($article->createur); ?></td>
                                                <!--end::Date=-->
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="<?php echo e(route('blog.show', $article->id)); ?>" class="menu-link px-3">View</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                            ...
                            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        <!--begin::Form-->
                                        <form class="form" action="<?php echo e(route('blog.store')); ?>" method="post">
                                            <!--begin::Modal header-->
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-header" id="kt_modal_add_customer_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder"><?php echo e(__("creer un article")); ?></h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2"><?php echo e(__("Titre")); ?></label>
                                                        <input type="text" class="form-control form-control-solid" name="titre" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2"><?php echo e(__("Titre en anglais")); ?></label>
                                                        <input type="text" class="form-control form-control-solid" name="titreEn" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2"><?php echo e(__("Description")); ?></label>
                                                        <input type="text" class="form-control form-control-solid" name="description" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2"><?php echo e(__("Description en anglais")); ?></label>
                                                        <input type="text" class="form-control form-control-solid" name="descriptionEn" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <!--begin::Label-->
                                                        <label class="fs-6 fw-bold mb-2">Categorie</label>
                                                        <select class="form-select" id="validationCustom04" name="catId" required>
                                                            <option selected disabled>Choix</option>
                                                            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($article->categories->id); ?>"><?php echo e($article->categories->titre); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
...
<?php /**PATH /Users/smartcode/Downloads/ADISA-BO-main/resources/views/apps/blog/list.blade.php ENDPATH**/ ?>