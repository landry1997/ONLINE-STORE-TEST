...
<head>
    <title><?php echo e(__('Editer une image')); ?> || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Editer une image')); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2"><?php echo e(__('Editer une image')); ?></h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Row-->
                                <form action="<?php echo e(url('/images/'.$image->id)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row py-4">
                                    ...
                                    <center>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom02" name="nom" value="<?php echo e($image->nom); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select statut" id="validationCustom07" name="statut" required>
                                                <option selected value="<?php echo e($image->statut); ?>"><?php echo e($image->statut); ?></option>
...
</html><?php /**PATH /home/denver99/SMARTCODE-PROJECT/ADISA-BO/resources/views/authentication/images/edit.blade.php ENDPATH**/ ?>