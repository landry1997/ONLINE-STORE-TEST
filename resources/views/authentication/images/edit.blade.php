...
<head>
    <title>{{ __('Editer une image') }} || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{ __('Editer une image') }}</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2">{{ __('Editer une image') }}</h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                ...
                                <form action="{{url('/images/'.$image->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <center>
                                        <div class="col-md-4">
                                            <label for="validationCustom02" class="form-label">{{ __('Nom de l\'image') }}</label>
                                            <input type="text" class="form-control" id="validationCustom02" name="nom" value="{{$image->nom}}" required>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select statut" id="validationCustom07" name="statut" required>
                                                <option selected value="{{ $image->statut }}">{{ $image->statut }}</option>
