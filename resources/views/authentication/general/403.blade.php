	...
	<body id="kt_body" class="auth-bg">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-center flex-column-fluid p-10">
				...
				<!--end::Message-->
				<!--begin::Link-->
				<a href="../../index-2.html" class="btn btn-primary">Return Home</a>
				<!--end::Link-->
			</div>
...
<!-- Mirrored from preview.keenthemes.com/craft/authentication/general/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:06:17 GMT -->
</html>