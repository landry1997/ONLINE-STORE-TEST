...
<head>
    <title>{{ __('Ajouter des videos') }} || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{ __('Ajouter des videos') }}</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">{{ __('Ajouter un livre') }}</li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                        ...
                        <div class="container-xxl">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-wrap flex-stack my-5">
                                    <!--begin::Title-->
                                    <h2 class="fs-2 fw-bold my-2">{{ __('Ajouter des videos') }}</h2>
                                    <!--end::Title-->
                                    <!--begin::Controls-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Row-->
                                <form action="{{ route('video.store') }}" method="POST" role="form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row py-4">
                                        <div class="col-lg-6 mx-auto">
                                            ...
                                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                                ...
                                                <label id="upload-label" for="image" class="font-weight-light text-muted">{{ __('Choisir une video') }}</label>
                                                <div class="input-group-append">
                                                    <label for="image" class="btn btn-light m-0 rounded-pill px-4"> <i class="fa fa-cloud-upload mr-2 text-muted"></i><small class="text-uppercase font-weight-bold text-muted">{{ __('Choisir une video') }}</small></label>
                                                </div>
                                            </div>
                                    ...
                                    <center>
                                        <div class="col-md-4">
                                            <label for="validationCustom02" class="form-label">{{ __('Nom de la video') }}</label>
                                            <input type="text" class="form-control" id="validationCustom02" name="nom" required>
                                            <div class="invalid-feedback">
                                                {{ __('Veuillez entrer le nom de la video') }}
                                            </div>
                                            @error('nom')
