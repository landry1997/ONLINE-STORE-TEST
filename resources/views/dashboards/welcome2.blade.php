...
<!--
Author: Keenthemes
Product Name: Craft - Multipurpose Bootstrap 5 HTML Admin Dashboard Theme 
...
<!-- Mirrored from preview.keenthemes.com/craft/dashboards/extended.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:05:26 GMT -->
...
<head>
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-extended-enabled aside-secondary-enabled">
		<!--begin::Main-->
		<!--begin::Root-->
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				<!--begin::Aside-->
				<div id="kt_aside" class="aside aside-extended ?php Theme::printHtmlClasses('aside', false);?&gt;" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'225px', '350px': '300px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle" data-kt-drawer-close="">
					<!--begin::Primary-->
					<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
						<!--begin::Brand-->
						<div class="aside-logo d-flex flex-column align-items-center flex-column-auto py-5 py-lg-10" id="kt_aside_logo">
							<a href="../index-2.html">
								<img alt="Logo" src="../assets/media/logos/logo-compact.svg" class="max-h-50px" />
							</a>
							<!--end::Logo-->
						</div>
						<!--end::Brand-->
							...
							<div class="hover-scroll-y" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								...
								<ul class="nav flex-column" role="tablist">
									...
									<li class="nav-item mb-1" title="Features">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light active" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_1" role="tab">
									...
									<li class="nav-item mb-1" title="Members">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_2" role="tab">
									...
									<li class="nav-item mb-1" title="Latest Reports">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_3" role="tab">
									...
									<li class="nav-item mb-1" title="Project Management">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_4" role="tab">
											<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
											<span class="svg-icon svg-icon-2x">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="black" />
									...
									<li class="nav-item mb-1" title="User Management">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_5" role="tab">
									...
									<li class="nav-item mb-1" title="Finance &amp; Accounting">
										<a href="#" class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light" data-bs-toggle="tab" data-bs-target="#kt_aside_tab_6" role="tab">
						...
						<!--end::Nav Wrapper-->
						<!--begin::Footer-->
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-4 py-lg-5" id="kt_aside_footer">
							<!--begin::Menu-->
							<div class="mb-2">
								<button type="button" class="btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light w-40px h-40px w-lg-50px h-lg-50px" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-container="body" data-bs-boundary="window" data-bs-trigger="hover" title="Settings">
								...
								<!--begin::Menu 1-->
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6139ea4792ba5">
									<!--begin::Header-->
									<div class="px-7 py-5">
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<!--begin::Input-->
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6139ea4792ba5" data-allow-clear="true">
													<option></option>
					...
					<div class="aside-secondary d-flex flex-row-fluid">
						<!--begin::Workspace-->
						<div class="aside-workspace overflow-auto my-7 px-5 px-lg-8" id="kt_aside_wordspace">
							<!--begin::Tab Content-->
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="kt_aside_tab_1">
									...
									<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
										<div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
											<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
												...
												<div class="menu-sub menu-sub-accordion menu-active-bg">
													...
													<div class="menu-item">
														<a class="menu-link active" href="extended.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															<div class="menu-item">
																<a class="menu-link" href="tabbed/overview.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="tabbed/projects.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="tabbed/activity.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="tabbed/documents.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
												...
												<div class="menu-sub menu-sub-accordion menu-active-bg">
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<a class="menu-link" href="../pages/profile/dashboard.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<a class="menu-link" href="../pages/projects/project.html">
																	...
																	<span class="menu-title">Project View</span>
																</a>
															</div>
															<div class="menu-item">
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<a class="menu-link" href="../pages/search/fancy.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Fancy</span>
																</a>
															</div>
														</div>
													</div>
												...
												<div class="menu-sub menu-sub-accordion menu-active-bg">
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<a class="menu-link" href="../modals/general/new-target.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="../modals/general/new-card.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="../modals/general/new-address.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
															...
															<div class="menu-item">
																<a class="menu-link" href="../modals/general/create-api-key.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<a class="menu-link" href="../modals/search/advanced.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
											...
											<div class="menu-item pt-5">
												<div class="menu-content">
													<span class="fw-bold text-muted text-uppercase fs-7">Apps</span>
												</div>
											</div>
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												<span class="menu-link">
											...
											<div class="menu-item">
												<a class="menu-link" href="../documentation/getting-started/changelog.html">
													...
													<span class="badge badge-changelog badge-light-danger bg-hover-danger text-hover-white fw-bold fs-9 px-2 ms-2">v1.0.8</span></span>
												</a>
											</div>
										</div>
									</div>
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
										...
										<div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-300px w-md-400px py-7 px-7 overflow-hidden">
											...
											<div data-kt-search-element="preferences" class="d-none">
												...
												<div class="d-flex justify-content-end pt-10">
													<button type="reset" class="btn btn-light btn-active-light-primary me-2 px-6" data-kt-search-element="preferences-dismiss">Cancel</button>
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column w-300px" data-kt-menu="true">
											...
											<div class="tab-content">
												...
												<div class="tab-pane fade show active" id="kt_topbar_quick_link_1">
													...
													<div class="px-9 pt-6 pb-4">
														...
														<div class="d-flex align-items-center item-border-hover px-3 py-2 ms-n3 mb-1">
															...
															<div class="pe-2">
																<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-boldest">Mivy App</a>
														...
														<div class="d-flex align-items-center item-border-hover px-3 py-2 ms-n3 mb-1">
															...
															<div class="pe-2">
																<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-boldest">Leaf CRM</a>
														...
														<div class="d-flex align-items-center item-border-hover px-3 py-2 ms-n3 mb-1">
															...
															<div class="pe-2">
																<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-boldest">Atica SR</a>
														...
														<div class="d-flex align-items-center item-border-hover px-3 py-2 ms-n3 mb-1">
															...
															<div class="pe-2">
																<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-boldest">Avionica</a>
													...
													<div class="py-5 text-center border-top">
														<a href="../pages/projects/list.html" class="btn bg-body text-primary p-0">View All Projects 
												...
												<div class="tab-pane fade" id="kt_topbar_quick_link_2">
													...
													<!--begin::View more-->
													<div class="py-5 text-center border-top">
														<a href="../pages/profile/campaigns.html" class="btn bg-body text-primary p-0">View All Campaigns 
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
														<span class="svg-icon svg-icon-3 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
												...
												<div class="tab-pane fade" id="kt_topbar_quick_link_3">
													...
													<!--begin::View more-->
													<div class="py-5 text-center border-top">
														<a href="../pages/projects/targets.html" class="btn bg-body text-primary p-0">View All Targets 
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
														<span class="svg-icon svg-icon-3 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3">
										<!--begin::Menu wrapper-->
										<div class="btn btn-icon btn-active-light-primary ?php echo $toolbarButtonHeightClass?&gt;" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-1">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<rect x="2" y="2" width="9" height="9" rx="2" fill="black" />
												...
												<div class="tab-pane fade pt-9" id="kt_topbar_notifications_1" role="tabpanel">
													...
													<div class="d-flex align-items-center px-9 mb-4">
														...
														<div class="mb-1 pe-3 flex-grow-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Developer Library added</a>
													...
													<div class="d-flex align-items-center px-9 mb-4">
														...
														<!--begin::Title-->
														<div class="mb-1 pe-3 flex-grow-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">New Order placed</a>
													...
													<div class="d-flex align-items-center px-9 mb-4">
														...
														<!--begin::Title-->
														<div class="mb-1 pe-3 flex-grow-1">
															<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">New user library added</a>
													...
													<!--begin::View more-->
													<div class="py-5 text-center border-top">
														<a href="../pages/profile/activity.html" class="btn bg-body text-primary p-0">View All 
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
														<span class="svg-icon svg-icon-3 svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
													...
													<div class="d-flex flex-column px-9">
														...
														<div class="pt-12">
															...
															<div class="text-center mt-5 mb-9">
																<a href="#" class="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Get Pro Access</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Section-->
						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder my-1 fs-2">Extended 
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<div class="card-header align-items-center border-0 mt-5">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6139ea47946f5">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-dark fw-bolder">Filter Options</div>
														</div>
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6139ea47946f5" data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
																		<option value="2">In Process</option>
...
<!-- Mirrored from preview.keenthemes.com/craft/dashboards/extended.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 11:05:27 GMT -->
</html>