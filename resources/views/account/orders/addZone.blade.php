...
<head>
    <title>{{ __('Ajouter des zones de livraison') }} || Adisa</title>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{ __('Création des zones de livraison') }}</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><a href="{{ route('zones-list') }}" class="text-muted text-hover-primary">{{__('Liste des piliers') }}</a></li>
                                    <li class="breadcrumb-item text-muted">{{ __('Créer une nouvelle zone de livraison') }}</li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                    ...
                    <form class="row g-3 needs-validation" method="post" action="{{ route('zones.add') }}" novalidate>
                        @csrf
                        <div class="col-md-6">
                            <label for="validationCustom01"
                                class="form-label">{{ __('Nom de la ville') }}</label>
                            <input type="text" class="form-control @error('nom_ville') is-invalid @enderror" id="validationCustom01" name="nom_ville" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nom_quartier') is-invalid @enderror" id="validationCustom02" name="nom_quartier" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control validate @error('nom_rue') is-invalid @enderror" id="validationCustom02" name="nom_rue" required>
                            <div class="invalid-feedback">
