...
<head>
    <title>{{ __('Editer le cours') }} {{ $cour[0]->nom }} || Adisa</title>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">{{ __('Editer le cours') }}
                                        {{ $cour[0]->nom }}</li>
                    ...
                    <form class="row g-3 needs-validation" method="post" action="{{ route('cour.update', $cour[0]->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class=" col-md-4">
                            <label for="validationCustom01" class="form-label">{{ __('Nom du cours en francais') }}</label>
                            <input type="text" class="form-control validate @error('nom') is-invalid @enderror" id="validationCustom01" value="{{ $cour[0]->nom }}" name="nom" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" value="{{ $cour[0]->nom_en }}" name="nom_en" required>
                            <div class="invalid-feedback">
                                {{ __('Veuillez entrer le nom du cours') }}
                            </div>
                            @error('nom_en')
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="validationCustom04" name="pilierId" required>
                                <option selected value="{{ $cour[0]->pilierId }}">{{ $cour[0]->pilier->titre }}
                                </option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control validate @error('description') is-invalid @enderror" id="validationCustom03" name="description" placeholder="{{ __('Description') }}" required>{{ $cour[0]->description }}</textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control validate @error('description_en') is-invalid @enderror" id="validationCustom05" name="description_en" placeholder="{{ __('Description') }}" required>{{ $cour[0]->description_en }}</textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select statut" id="validationCustom07" name="statut" required>
                                <option selected value="{{ $cour[0]->statut }}">{{ $cour[0]->statut }}</option>
                        ...
                        <div class="col-md-3">
                            <label for="validationCustom04" class="form-label">{{ __('Choix du type') }}</label>
                            <select class="form-select type" id="type" name="type" required>
                                <option selected value="{{ $cour[0]->type }}">{{ $cour[0]->type }}</option>
                                <option value="payant">payant</option>
                                <option value="non payant">non payant</option>
                            </select>
                            <div class="invalid-feedback">
                                {{ __('Choisissez un type') }}
                            </div>
                            @error('type')
                            <span class="invalid-feedback alert alert-primary" role="alert-danger " value="{{ old('type') }}">
                                <p class="danger"> {{ $message }}</p>
                            </span>
                            @enderror
                        </div>
