...
<head>
    <title>{{ __('Ajouter des pîliers') }} || Adisa</title>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">{{ __('Créer un nouveau pilier') }}</li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                    ...
                    <form class="row g-3 needs-validation" method="post" action="{{ route('pilier.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">{{ __('Nom du pilier en francais') }}</label>
                            <input type="text" class="form-control" id="validationCustom01" name="titre" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" name="titre_en" required>
                            <div class="invalid-feedback">
                                {{ __('Veuillez entrer le nom du pilier') }}
                            </div>
                            @error('titre_en')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="validationCustom03" name="contenu" placeholder="{{ __('Description') }}" required></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            <label for="validationCustom03" class="form-label">{{ __('Description du pilier en anglais') }}</label>
                            <textarea class="form-control" id="validationCustom03" name="contenu_en" placeholder="{{ __('Description') }}" required></textarea>
                            <div class="invalid-feedback">
