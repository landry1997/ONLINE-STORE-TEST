...
<head>
    <title>{{__('Liste des articles du blog') }} || Adisa </title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Liste des articles') }}</h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    <li class="breadcrumb-item text-muted">
                                        <a href="/home" class="text-muted text-hover-primary">{{__('Tableau de bord') }}</a>
                                    </li>
                                    <li class="breadcrumb-item text-muted">{{__("Blog") }}</li>
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{__("creer un article") }}</button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-60px">{{__("description") }}</th>
                                                <th class="min-w-100px">{{__("Date de creation") }}</th>
                                                <th class="min-w-100px">{{__("Categorie") }}</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Email=-->
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $article->description }}</a>
                                                </td>
                                                <!--end::Email=-->
                                                <!--begin::Company=-->
                                                ...
                                                <td data-filter="american_express">{{ $article->catId }}</td>
                                                <td>{{ $article->createur }}</td>
                                                <!--end::Date=-->
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form" action="{{ route('blog.store') }}" method="post">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_customer_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder">{{__("creer un article") }}</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2">{{__("Description") }}</label>
                                                        <input type="text" class="form-control form-control-solid" name="description" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2">{{__("Description en anglais") }}</label>
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <select class="form-select" id="validationCustom04" name="catId" required>
                                                            ...
                                                            @foreach ($articles as $article)
                                                            <option value="{{ $article->categories->id }}">{{ $article->categories->titre  }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer flex-center">
                                                <!--begin::Button-->
                                                <button type="reset" id="kt_modal_add_customer_cancel" class="btn btn-light me-3">{{__("Annuler") }}</button>
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <button type="submit" id="kt_modal_add_customer_submit" class="btn btn-primary">
														<span class="indicator-label">{{__("creer") }}</span>
