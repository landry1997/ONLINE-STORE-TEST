...
<head>
		<title>{{__('Details de cet article') }} || Adisa </title>
											...
											<div class="card-body pt-15">
												...
												<div id="kt_customer_view_details" class="collapse show">
													<div class="py-5 fs-6">
														...
														<div class="text-gray-600">{{$articles->titre}}</div>
														<div class="fw-bolder mt-5">{{__("Titre en anglais") }}</div>
														<div class="text-gray-600">
															<a href="#" class="text-gray-600 text-hover-primary">{{$articles->titreEn}}</a>
														</div>
														<div class="fw-bolder mt-5">{{__("Description") }}</div>
														<div class="text-gray-600">{{$articles->description}}</div>
														<div class="fw-bolder mt-5">{{__("Description en anglais") }}</div>
														<div class="text-gray-600">{{$articles->descriptionEn}}</div>
														<div class="fw-bolder mt-5">{{__("Createur") }}</div>
														<div class="text-gray-600">{{$articles->user->name}}</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
												...
												<div class="card pt-4 mb-6 mb-xl-9">
													...
													<div class="card-header border-0">
														<div class="card-title">
															<h2>{{__("Liste des commentaires") }}</h2>
														</div>
													</div>
								...
								<div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered mw-650px">
										<div class="modal-content">
											<form class="form" method="POST" action="{{ route('blog.update', $articles->id) }}">
                                                @csrf
												<div class="modal-header" id="kt_modal_update_customer_header">
													<h2 class="fw-bolder">{{__("Modifier cet article") }}</h2>
													...
													<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_customer_header" data-kt-scroll-wrappers="#kt_modal_update_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div id="kt_modal_update_customer_user_info" class="collapse show">
															<div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Titre") }}</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="titre" value="{{$articles->titre}}" />
															</div>
                                                            <div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Titre") }}</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="titre" value="{{$articles->titre}}" />
                                                            ...
                                                            <div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Titre en anglais") }}</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="titreEn" value="{{$articles->titreEn}}" />
															</div>
                                                            <div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Description") }}</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="description" value="{{$articles->description}}" />
															</div>
                                                            <div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Description en anglais") }}</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="descriptionEn" value="{{$articles->descriptionEn}}" />
															</div>
                                                            <div class="fv-row mb-7">
																<label class="fs-6 fw-bold mb-2">{{__("Statut") }}</label>
                                                                <select class="form-select" id="validationCustom04" name="statut" required>
                                                                    <option selected value="{{ $articles->statut }}">{{ $articles->statut}}
                                                                    </option>
