...
<head>
    <title>{{__('Liste des questions aux questions') }} || Adisa </title>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Details des questions') }}</h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted"><a href="{{ route('questions-list') }}" class="text-muted text-hover-primary">{{__("Gestion des questions") }}</a></li>
                                    <li class="breadcrumb-item text-dark">{{__("details des questions") }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
												...
												<div class="card-body border-top p-9">
													<div class="row mb-7">
														<div class="col-lg-5 fs-4 mb-6 mb-lg-0">
															<div>
															<span class="fw-boldest text-gray-800 me-1">{{__("Createur ")}}</span>{{$questions->user->name}}</div>
															<div>{{__("Date de creation ")}}, {{$questions->created_at}}</div>
														</div>
														<div class="col-lg-7">
													...
													<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed rounded p-6">
														...
														<div class="d-flex flex-stack flex-grow-1">
															<div class="fw-bold">
																<h4 class="fw-bolder">{{__("Cours : ")}}
                                                                    <td class="text-dark">{{$questions->cours->nom}}</td>
                                                                </h4>
                                                                <h4 class="fw-bolder">{{__("Question : ")}}
                                                                    <td class="text-dark">{{$questions->contenu}}</td>
                                                                    <span style="margin-left: 20px;">
                                                                        <i class="fas fa-edit" data-bs-toggle="modal" title="Modifier le contenu"  data-bs-target="#kt_modal_edit_contenu_form"></i>
                                                                    </span>
                                                                </h4>
																<div>{{__("Statut : ")}}
                                                                    <td class="text-dark">{{$questions->statut}}</td>
                                                                    <span style="margin-left: 20px;">
                ...
                <div class="modal fade" id="kt_modal_edit_contenu_form" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <div class="modal-content">
                            <form class="form" action="{{ route('questions.statut', $questions->id) }}" method="POST" id="kt_modal_edit_contenu_form" data-kt-redirect="list.html">
                                @csrf
                                ...
                                <div class="modal-body py-10 px-lg-17">
                                    ...
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="" value="{{$questions->contenu}}" name="contenu"/>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="kt_modal_edit_statut_customer" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <div class="modal-content">
                            <form class="form" action="{{ route('questions.statut', $questions->id) }}" method="POST" id="kt_modal_edit_statut_form" data-kt-redirect="list.html">
                                @csrf
                                <div class="modal-header" id="kt_modal_add_customer_header">
                                    <h2 class="fw-bolder">{{__("creer une question") }}</h2>
                                    <div id="kt_modal_add_customer_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                        ...
                                        <div class="fv-row mb-7">
                                            <label class="required fs-6 fw-bold mb-2">{{__("Statut de la question") }}</label>
                                                <select class="form-select form-select-solid fw-bolder" name="statut" data-kt-select2="true" data-placeholder="{{__("Choisir un statut pour cette question") }}" data-allow-clear="true">
                                                    <option value="{{$questions->statut}}" disabled>{{$questions->statut}} </option>
