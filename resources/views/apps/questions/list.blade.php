...
<head>
    <title>{{__('Liste des questions des cours') }} || Adisa </title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Liste des questions') }}</h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    <li class="breadcrumb-item text-muted">
                                        <a href="/home" class="text-muted text-hover-primary">{{__('Tableau de bord') }}</a>
                                    </li>
                                    <li class="breadcrumb-item text-muted">{{__("Comptes ef cours") }}</li>
                                    <li class="breadcrumb-item text-muted">{{__("Gestion des questions") }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-60px">{{__("Instructions") }}</th>
                                                <th class="min-w-60px">{{__("Cours") }}</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1">{{ $question->contenu }}</a>
                                                </td>
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $question->instructions }}</a>
                                                </td>
                                                <td>{{ $question->cours->nom }}</td>
                                                <td data-filter="american_express">{{ $question->statut }}</td>
                                                ...
                                                <td class="text-end">
                                                    <span>
                                                        ...
                                                        <span>
                                                            <a href="{{ route("questions.show", $question->id)}}">  <i class="fas fa-eye" title="Voir le detail" ></i></a>
                                                        </span>
                                                        <span>
                            ...
                            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <form class="form" action="{{ route('questions.store') }}" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="list.html">
                                            @csrf
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <label class="required fs-6 fw-bold mb-2">{{__("Instructions") }}</label>
                                                        <input type="text" class="form-control form-control-solid" placeholder="cochez une ou plusieurs reponses" name="instructions"/>

                                                        <label class="required fs-6 fw-bold mb-2">{{__("Cours") }}</label>
                                                           <!--begin::Input-->
                                                           <select class="form-select form-select-solid fw-bolder" name="coursId" data-kt-select2="true" data-placeholder="{{__("Choisir un cours") }}" data-allow-clear="true">
                                                            <option></option>
