                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Liste des coupons de reduction') }}</h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    <li class="breadcrumb-item text-muted">
                                        <a href="/home" class="text-muted text-hover-primary">{{__('Table   au de bord') }}</a>
                                    </li>
                                    <li class="breadcrumb-item text-muted">{{__("Coupons") }}</li>
                                    <li class="breadcrumb-item text-muted">{{__("Liste des coupons") }}</li>
                                </ul>
                            </div>
                            <!--end::Info-->
                            <!--begin::Actions-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{__("creer un coupon") }}</button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-60px">{{__("Pourcentage") }}</th>
                                                <th class="min-w-100px">{{__("Date de creation") }}</th>
                                                <th class="min-w-100px">{{__("Date de fin") }}</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Name=-->
                                                <td>
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1">{{ $coupon->code }}</a>
                                                </td>
                                                <!--end::Name=-->
                                                <!--begin::Email=-->
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $coupon->pourcentage }}</a>
                                                </td>
                                                <!--end::Email=-->
                                                <!--begin::Company=-->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="list.html">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_customer_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder">{{__("creer un coupon") }}</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <!--begin::Label-->
                                                        <label class="required fs-6 fw-bold mb-2">{{__("Utilisateur") }}</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
