...
<head>
    <title>{{__('Liste des categories des articles') }} || Adisa </title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Liste des categories') }}</h1>
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">{{__("Liste des articles") }}</li>
                                </ul>
                            </div>
                            <!--end::Info-->
                            <!--begin::Actions-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{__("creer une categorie") }}</button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px">{{__("Titre") }}</th>
                                                <th class="min-w-60px">{{__("Titre en anglais") }}</th>
                                                <th class="min-w-100px">{{__("Statut") }}</th>
                                                <th class="min-w-100px">{{__("Date de creation") }}</th>

                                                <th class="min-w-100px">{{__("Createur") }}</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Name=-->
                                                <td>
                                                    <a href="view.html" class="text-gray-800 text-hover-primary mb-1">{{ $category->titre }}</a>
                                                </td>
                                                <!--end::Name=-->
                                                <!--begin::Email=-->
                                                <td>
                                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $category->titreEn }}</a>
                                                </td>
                                                <!--end::Email=-->
                                                <!--begin::Company=-->
                                                ...
                                                <td data-filter="american_express">{{ $category->created_at }}</td>
                                                <td>{{ $category->createur }}</td>
                                                <!--end::Date=-->
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('categories.show', $category->id) }}" class="menu-link px-3">{{__("Detail") }}</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">{{__("Desactiver") }}</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                            ...
                            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        <!--begin::Form-->
                                        <form class="form" action="{{ route('categories.store') }}" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="list.html">
                                            <!--begin::Modal header-->
                                            @csrf
                                            <div class="modal-header" id="kt_modal_add_customer_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder">{{__("creer une categorie") }}</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <label class="required fs-6 fw-bold mb-2">{{__("Titre") }}</label>
                                                        <input type="text" class="form-control form-control-solid" placeholder="" name="titre"/>

                                                        <label class="required fs-6 fw-bold mb-2">{{__("Titre en anglais") }}</label>
