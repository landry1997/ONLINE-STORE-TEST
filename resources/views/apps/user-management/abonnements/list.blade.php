...
<head>
    <title>{{ __('Liste des abonnements') }} || Adisa</title>
                        ...
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">{{__('Gestion des abonnements') }}</li>
                                    <li class="breadcrumb-item text-muted">{{__('abonnements') }}</li>
                                    <li class="breadcrumb-item text-dark">{{__('Liste des abonnements') }}</li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px">{{ __('Durée') }}</th>
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            @foreach ($abonnements as $abon)
                                                <tr>
                                                    ...
                                                    <td>{{ $abon->durée }} {{__('jours') }}</td>
                                                    <td>{{ $abon->prix }} FCFA</td>
                                                    <td>{{ $abon->createur }}</td>
