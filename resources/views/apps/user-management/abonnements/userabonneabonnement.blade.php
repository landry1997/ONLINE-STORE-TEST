...
<head>
    <title>{{ __('Liste des abonnements des utilisateurs') }} || Adisa</title>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Liste des abonnements') }}</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb fw-bold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">{{__('Gestion des abonnements des utilisateurs') }}</li>
                                    <li class="breadcrumb-item text-muted">{{__('abonnements') }}</li>
                                    <li class="breadcrumb-item text-dark">{{__('Liste des abonnements des utilisateurs') }}</li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Info-->
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            <!--begin::Filter-->
                                        <a href="{{ route('abonnement.create') }}" class="btn btn-dark">{{__('Créer un nouvel abonnement') }}</a>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px">{{ __('Utilisateur') }}</th>
                                                <th class="min-w-100px">{{ __('Prix') }}</th>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('abonnement.edit', $abon->id) }}"
